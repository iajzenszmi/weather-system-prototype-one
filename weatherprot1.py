...
class MessageQueue:
    ...
    def publish(self, topic, message):
        ...
        print(f"--- ⬆️  New Message on Queue ---")
        print(f"  Topic: {topic}")
...
class WebSocketServer:
    ...
    def push_to_user(self, user_id, payload):
        if user_id in self.active_users:
            print(f"💥 [WebSocket PUSH to {user_id}] --> {payload}")
...
class PushNotificationService:
    ...
    def on_send_push(self, message):
        ...
        print(f"✅ [PushNotificationService] Push sent to '{user_id}'!")
...
print("="*40)
print("🌦️  BOM SYSTEM SIMULATION STARTING 🌦️")
print("="*40)
